...
% sliding bar
\def\tline#1{
\put(94,-4){\small \blue{t}}
\put(-1,-4){\small \blue{0}}
\thicklines
\put( 0,0){\color{blue} \vector(1,0){95}}
\put(#1,0){\color{blue} \circle*{2}}
}
